...
$(function () {
    ...
    (function () {
        ...
        (function () {
            ...
            $('#miniSuccessTitle_insert').click(function () {
                Lobibox.notify('success', {
                    title: 'Successfully.',
					showClass: 'rollIn',
                    hideClass: 'rollOut',
                    msg: 'Data has been added to database successfully.'
                });
            });
			
			$('#miniSuccessTitle_update').click(function () {
                Lobibox.notify('success', {
                    title: 'Successfully.',
					showClass: 'rollIn',
                    hideClass: 'rollOut',
			...
			$('#miniSuccessTitle_send').click(function () {
                Lobibox.notify('success', {
                    title: 'Successfully.',
					showClass: 'rollIn',
                    hideClass: 'rollOut',
                    msg: 'Data has been send to your email successfully.'
                });
            });
			
			$('#miniSuccessTitle_nonesend').click(function () {
                Lobibox.notify('error', {
                    title: 'Error.',
					showClass: 'rollIn',
                    hideClass: 'rollOut',
                    msg: 'Data has been send to your email error! Please check your email again...'
                });
            });
			
			$('#miniSuccessTitle_delete').click(function () {
                Lobibox.notify('error', {
                    title: 'Successfully.',
					showClass: 'rollIn',
                    hideClass: 'rollOut',
