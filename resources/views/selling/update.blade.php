				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-flat">
							...
							<form id="myForm" method="post" action="{{url('selling/update')}}">
							{{ csrf_field() }}
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="input-group">
															<input type="text" name="docdate" id="docdate" placeholder="วันที่" class="form-control datepicker-dates" onkeydown="return false;" autocomplete="off" value="{{ $selling->selling_date}}">
														</div>
													</div>
												</div>
														...
														<table id="myTable" class="table table-framed">
															<thead>
																<tr>
																	...
																	<th class="text-center">จำนวนคงเหลือ(ตามออเดอร์)</th>
																...
																@if(!empty($order))
																	...
																	<tr class="rowproduct" id="row{{ $dataorder->product_id }}">
																		...
																		<td align="center">
																			...
																			<input type="text" class="form-control number" name="productqty[]" id="qty{{ $dataorder->product_id }}" onkeyup="qtypush({{ $dataorder->product_id }})" value="{{ $dataorder->sellingdetail_qty }}" style="width:70px">
																		</td>
																		...
																		<td align="center">{{ $dataorder->balance }}</td>
															...
															<div class="form-group">
																...
																<div class="col-md-8">
																	<select class="form-control" name="status">
																		...
																		<option value="1" @if($selling->selling_status == '1') selected @endif> เรียบร้อย </option>
																		<option value="3" @if($selling->selling_status == '3') selected @endif> ยกเลิก </option>
																		<option value="4" @if($selling->selling_status == '4') selected @endif> แพ็คของแล้ว </option>
																		<option value="5" @if($selling->selling_status == '5') selected @endif> จัดขนส่งแล้ว </option>
																		<option value="6" @if($selling->selling_status == '6') selected @endif> แพ็คของยังไม่ครบ </option>
																		<option value="7" @if($selling->selling_status == '7') selected @endif> จัดใบเก็บเงิน </option>
																		<option value="8" @if($selling->selling_status == '8') selected @endif> จ่ายเงินเรียบร้อย </option>
																	</select>
