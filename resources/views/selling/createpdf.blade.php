            ...
            <table style="width:100%;border-collapse: collapse;border-spacing: 0 1em;">
                <thead>
                    ...
                    <tr>
                        ...
                        <td colspan="7" style="border-bottom:1px solid;border-top:1px solid;height:35px;vertical-align: middle;text-align: center;">&nbsp;&nbsp;หมายเหตุ : บัญชี @if(count($accountbill) == 0) {{ $settingbill->setheadbill_selectaccount}} @else $accountbill->setheadbillaccount_name @endif </td>
                    </tr>
                    <tr>
