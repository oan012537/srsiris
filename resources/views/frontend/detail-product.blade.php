...
<html lang="th">
  <head>      
    ...
    <link rel="stylesheet" href="{{asset('assetsfrontend/css/flexslider.css')}}"  type="text/css" media="screen">  
    <script type="text/javascript"   src="{{asset('assetsfrontend/js/modernizr.js')}}"></script>  
	<script type="text/javascript" src="{{asset('assetsfrontend/js/jquery.flexslider.js')}}"></script>
    ...
    <div id="section1">  
        <div class="container">
            <div class="row bg-gray py-3 ">
                <div class="col">
                <p><a href="{{url('/')}}" class="text-dark">หน้าแรก</a> > <a href="" class="text-dark">ชื่อหมวดหมู่สินค้า</a> > <a href="" class="text-dark">ชื่อสินค้า</a></p>
                </div>
            </div>
        </div>
    </div>  
            ...
            <div class="row bg-white py-5"> 
                <div class="col-sm-5 p-2">
                   <div class="flexslider">
                      <ul class="slides">
                        <li data-thumb="{{asset('assetsfrontend/image/picture.png')}}">
                          <img  src="{{asset('assetsfrontend/image/picture.png')}}" />
                        </li>
                        <li data-thumb="{{asset('assetsfrontend/image/picture.png')}}">
                          <img src="{{asset('assetsfrontend/image/picture.png')}}" />
                        </li>
                ...
                <div class="col-sm-7">
                   ...
                   <hr>
                    ...
                    <a class="btn btn-yellow btn-lg my-4 mr-3 px-5 py-3" href="{{url('/payment')}}">ซื้อเลย</a><a class="btn btn-borderBlack btn-lg my-4 px-5 py-3" href="{{url('/cart')}}"><i class="fa fa-shopping-cart"></i> ใส่รถเข็น</a>
                </div>
            </div>
        </div>
    </div>
