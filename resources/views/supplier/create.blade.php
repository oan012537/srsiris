				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-flat">
							...
							<form method="post" action="{{url('supplier_create')}}" enctype="multipart/form-data">
							{{ csrf_field() }}
									...
									<div class="col-md-6 col-md-6 col-md-offset-3">
										<fieldset>
											...
											<div class="form-group">
                                                <label>ที่อยู่ :</label>
                                                <div class="input-control">
                                                    <input class="col-sm-12 form-control" id="location" name="location" type="text" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-control">
                                                    <input type="text" class="form-control" name="latandlong" id="latandlong" onkeypress="return false">
                                                </div>
                                            </div>
											<div class="form-group">
