            ...
            <table style="width:100%;border-collapse: collapse;border-spacing: 0 1em;">
                <thead style="">
                    <tr style="margin-top: 20px;">
                        ...
                        <td width="35%" style="border:2px solid;text-align:center;line-height:15px;vertical-align: middle;padding:20px 0px;"><h1>{{ date("d/m",strtotime($data[0]->trans_date)) }}/{{ trandate(date("Y",strtotime($data[0]->trans_date)))}}</h1></td>
                    </tr>
                </thead>
            </table>
        {{-- </div> --}}
        ...
        <div style="border:2px #ffff solid;border-bottom:2px #ffffff solid;border-radius: 0%;margin-top: -8px">
            <table style="width:100%;border-collapse: collapse;border-spacing: 0 1em;">
                <thead>
                    ...
                    $shippingcost += $item->selling_shippingcost;
                    @endphp
                    <tr>
            ...
            <thead>
                <tr>
                    <td width="100%" style="padding:0px 40px;height:35px;vertical-align: middle;text-align: left;">
                        จำนวนบิลที่ชมพูหลังออกส่งวันที่ปัจจุบัน...........{{ $countcopy }}.............บิล...........{{ $countpacking }}..............โพย&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ลายเซ็น...................................................................................(แพ๊คสินค้า)
                    </td>
                </tr>
                <tr>
                    <td width="100%" style="padding:0px 40px;height:35px;vertical-align: middle;text-align: left;">
                        จำนวนบิลวันที่ปัจจุบันในคอม............{{ $countdata}}............บิล/บิลต้นฉบับ........{{$countcopy+$countpacking}}...............โพย&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ลายเซ็น...................................................................................(ออฟฟิต)
                    </td>
                </tr>
                {{ $balance = 0 }}
                @if(count($transportexpen) > 0)
                {{ $balance = $transportexpen[count($transportexpen)-1]->transportexpen_balance }}
                @endif
                <tr>
                    <td width="100%" style="padding:0px 40px;height:35px;vertical-align: middle;text-align: left;">
                        ค่าขนส่ง...............{{$shippingcost}}.................เงินสดคงเหลือ.................{{$balance-$shippingcost}}.....................
                    </td>
                </tr>
                {{-- @if(!empty($transportexpen))
                    <tr style="padding:0px;border:1px solid;width: 50%">
                    <td width="45%" style="padding:0px 40px;">เงินเบิก      {{$transportexpen[0]->transportexpen_withdraw}}</td>
                    </tr>
                    @foreach($transportexpen as $expen)
                    <tr style="padding:0px;">
                    <td width="45%" style="padding:0px 40px;">{{$expen->transportexpen_detail}}      {{$expen->transportexpen_expen}}</td>
                    </tr>
                    @endforeach
                @endif --}}
                <tr >
                    <td width="100%" rowspan="3" style="padding:0px;padding-right:100px;height:35px;vertical-align: middle;text-align: right;">
                        ผู้จัดการ...........................................................................
                    </td>
                </tr>
            </thead>
